...
public class JpaCacheUserSessionAdapter implements UserSessionModel {
    ...
    public JpaCacheUserSessionAdapter(KeycloakSession session, RealmModel realm, UserSession userSessionEntity, UserSessionRepository userSessionRepository) {
    ...
    private AuthenticatedClientSessionModel clientSessionEntityToModel(AuthenticatedClientSessionValue clientSessionEntity) {
        return new JpaCacheAuthenticatedClientSessionAdapter(session, realm, this, clientSessionEntity) {
            @Override
