...
public class JpaCacheUserSessionProvider implements UserSessionProvider {
  ...
  public Stream<UserSessionModel> getUserSessionsStream(RealmModel realm, ClientModel client) {
    ...
    TypedQuery<AuthenticatedClientSessionValue> query =
        entityManager.createNamedQuery("findClientSessionsByClientId", AuthenticatedClientSessionValue.class);
    query.setParameter("realmId", realm.getId());
  ...
  public Stream<UserSessionModel> getUserSessionsStream(RealmModel realm, ClientModel client, Integer firstResult, Integer maxResults) {
    ...
    query.setParameter("realmId", realm.getId());
    query.setParameter("clientId", client.getId());
    return closing(paginateQuery(query, firstResult, maxResults)
                   .getResultStream()
                   .map(AuthenticatedClientSessionValue::getParentSession)
                   .map(entityToAdapterFunc((realm)))
                   )
  ...
  public void removeUserSessions(RealmModel realm) {
    entityManager.createNamedQuery("removeAllUserSessions").setParameter("realmId", realm.getId()).executeUpdate();
  }
  ...
  private UserSession createUserSessionEntityInstance(String id, String realmId, String userId, String loginUsername, String ipAddress, String authMethod, boolean rememberMe, String brokerSessionId, String brokerUserId, boolean offline) {
    ...
    return UserSession.builder()
        ...
        .brokerUserId(brokerUserId).offline(offline)
        .timestamp(timestamp)
